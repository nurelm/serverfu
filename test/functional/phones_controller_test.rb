...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { contact_id: @phone.contact_id, description: @phone.description, phone: @phone.phone }
    end
  ...
  test "should update phone" do
    put :update, id: @phone, phone: { contact_id: @phone.contact_id, description: @phone.description, phone: @phone.phone }
    assert_redirected_to phone_path(assigns(:phone))
  end
